  ...
  return (
    <nav className="w-full bg-slate-900 text-white sticky top-0 z-50 shadow-lg">
      ...
      <div
        className={`${
          isOpen ? "block" : "hidden"
        } md:hidden w-full bg-slate-800 border-t border-slate-700 flex flex-row`}
      >
        {/* Left Side */}
        <div className="flex w-1/2 flex-col p-4 space-y-4 border rounded-lg">
          ...
          <Link
            onClick={closeMenu}
            to="/ai"
            className="block hover:text-blue-400 font-bold"
          >
            Yatri(AI)
          </Link>
        </div>
          ...
          {user ? (
            ...
            <>
              <Link
                onClick={closeMenu}
                to="/signup"
                className="bg-green-600 px-8 py-2 rounded-lg font-bold hover:bg-green-500 transition"
              >
                Signup
              </Link>
              ...
              <Link
                onClick={closeMenu}
                to="/login"
                className="bg-blue-600 px-10 py-2 rounded-lg font-bold hover:bg-blue-500 transition"
              >
                Login
              </Link>
            </>
